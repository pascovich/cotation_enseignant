...
$requette=$db->prepare("SELECT * FROM auth_etudiant_view limit 1 ");
$requette->execute();
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">
                            <?php if($_SESSION['user']!=''): 
                                echo strtoupper($_SESSION['user']['noms']) ;
                            endif; ?>
                        </h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Annee Academique (Academic Year)</div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Inscrit en (Option&Promotion)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?=$p['prom'];?>
                                            </div>
                                        </div>
                     ...
                     <!--    <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Profile Etudiant</h6>
