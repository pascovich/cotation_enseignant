...
<script>
    ...
    $(document).on('click', '.update', function(){
        var id_inscription = $(this).attr("id");
        $.ajax({
            url:"fetch/inscription_fetch_single.php",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                $('.modal-title').text("Editer les infos de l'inscription");
                $('#id_inscription').val(id_inscription);
                $('#action').val("Edit");
                $('#operation').val("Edit");
            }
        })
